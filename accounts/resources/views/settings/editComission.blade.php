                        ...
                        <div class="nk-content-body">
                           <div class="nk-block-head nk-page-head">
                              ...
                              <table style="width:100%">
                                    <tbody><tr>
                                       <td><h1 class="nk-block-title">EDIT STUDENT PIC COMMISSION</h1></td>
                                       <td></td>
                                    </tr>
                                 </tbody></table>
                              </div>
                           ...
                           <div class="nk-block">
                              <div class="card">
                                 <div class="card-body">
                                 <form method="POST" action="{{route('submitEditComission')}}">
                              @csrf
                                    <input type="hidden" name="id" value="{{$studentcomissions->id}}" />
