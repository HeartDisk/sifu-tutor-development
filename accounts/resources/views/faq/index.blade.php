                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          <a class="dtable-cbtn bt-delete dtb-tooltip" dtb-tooltip="Delete" onclick="return confirm('Are you sure you want to delete this News?');" href="{{url('faq/delete',$faq->id)}}"><i class="fa fa-trash"></i> </a>
                                        </td>
                                    </tr>
                                    @endforeach
                                </tbody>
