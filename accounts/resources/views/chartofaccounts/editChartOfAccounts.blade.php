                        ...
                        <div class="nk-block-head-content">
                          <div class="d-flex flex-column flex-md-row align-items-md-center">
                            <div class="mt-3 mt-md-0 ms-md-3">
                              <h3 class="title mb-1">Edit Chart Of Accounts: {{$chartofaccounts->name}}</h3>
                            </div>
                          </div>
                        </div>
                          ...
                          <form method="POST" action="{{route('submitChartOfAccounts')}}">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                  ...
                                  <div class="form-control-wrap"><input type="text" class="form-control" readonly name="accountID" value="{{$chartofaccounts->uid}}" id="uid"></div>
                                </div>
                              </div>
                            <div class="col-lg-3">
                                <div class="form-group">
                                  <label for="firstname" class="form-label">Account Code</label>
                                  <div class="form-control-wrap"><input type="text" class="form-control" name="account_code" value="{{$chartofaccounts->code}}" id="account_code"></div>
                                </div>
                              </div>
                               ...
                               <div class="col-lg-3">
                                <div class="form-group">
                                  ...
                                  <div class="form-control-wrap"><input type="text" class="form-control" name="account_name" value="{{$chartofaccounts->name}}" id="account_name"></div>
                                </div>
                              </div>
                                ...
                                <div class="form-group">
                                  ...
                                  <div class="form-control-wrap">
                                    <select class="js-select" id="account_type" data-search="true" name="account_type" data-sort="false">
                                        <option selected="selected">{{$chartofaccounts->type}}</option>
                               ...
                               <div class="col-lg-3" style="margin-top:40px;">
                                <div class="form-group" style="display:flex;">
                                  ...
                                  <div class="form-control-wrap"><input type="checkbox"  @if($chartofaccounts->is_cash_source == 1) checked @endif fname="cash_source" id="cash_source"></div>
                                </div>
                              </div>
                              ...
                              <div class="col-lg-9">
                                <div class="form-group">
                                  ...
                                  <div class="form-control-wrap"><input type="text" class="form-control" value="{{$chartofaccounts->description}}" name="description" id="description"></div>
                                </div>
                              </div>
