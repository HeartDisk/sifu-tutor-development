                              ...
                              <div class="row">
                                 ...
                                 <div class="col-lg-3">
                                    <div class="form-group">
                                       ...
                                       <div class="form-control-wrap">
                                          <input type="text" class="form-control" name="customerEmail" id="email" value="{{$customers->email}}">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-lg-3">
                                    <div class="form-group">
                                       ...
                                       <div class="form-control-wrap">
                                          <input type="tel" minlength="9" maxlength="10" class="form-control" name="customerPhone" id="mobile_code" value="{{$customers->phone}}">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-lg-3">
                                    <div class="form-group">
                                       ...
                                       <div class="form-control-wrap">
                                          <input type="tel" minlength="9" maxlength="10" class="form-control" name="customerWhatsapp" id="whatsapp_code" value="{{$customers->whatsapp}}">
                                       </div>
                                    </div>
                                 </div>
                              </div>
                              <div class="row">
                                 ...
                                 <div class="col-lg-6">
                                    <div class="form-group">
                                       ...
                                       <div class="form-control-wrap">
                                          <input type="text" class="form-control" name="customerStreetAddress1" id="address" value="{{$customers->address1}}">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-lg-3">
