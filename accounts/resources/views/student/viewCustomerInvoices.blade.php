          ...
          <div class="nk-block-head-between gap g-2">
            <div class="gap-col">
              <ul class="nav nav-pills nav-pills-border gap g-3" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                  <a class="nav-link active" href="{{route('customerInvoices',$customer->id)}}"> Invoices & Payments </a>
                </li>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" href="{{route('customerCommentmentFees',$customer->id)}}"> Commitment Fees</a>
                </li>
              </ul>
            </div>
            <div class="gap-col">
              <ul class="d-flex gap g-2">
                ...
                <li class="d-md-none">
                  <a href="{{route('editCustomer',$customer->id)}}" class="btn btn-soft btn-primary btn-icon">
                    <em class="icon ni ni-edit"></em>
                  </a>
                </li>
              </ul>
            ...
            <div class="tab-pane show active" id="tab-1" tabindex="0" role="tabpanel">
              <div class="card card-gutter-md">
                <div class="card-row card-row-lg col-sep col-sep-lg">
                  ...
                  <div class="card-content col-sep" style="width: 70%;">
                    <div class="card-body">
                      <div class="bio-block">
                        ...
                        <table class="table table-striped">
                            ...
                            @php
                                $tickets = DB::table('studentinvoices')->where('isPaid','=','unpaid')->where('studentID','=',$rowStudent->id)->first();
                            @endphp
                            @if($tickets)
                                <tr>
                                    <td> <a target="_blank" href="{{route('viewTicket',$tickets->ticketID)}}">{{$tickets->ticketID}}</a> </td>
                                    <td> 
                                        @php
