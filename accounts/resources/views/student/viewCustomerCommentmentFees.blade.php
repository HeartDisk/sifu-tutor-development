            ...
            <div class="gap-col">
              <ul class="nav nav-pills nav-pills-border gap g-3" role="tablist">
                <li class="nav-item" role="presentation">
                  <a href="{{route('customerDashboard',$customer->id)}}" class="nav-link"> Overview </a>
                </li>
                <li class="nav-item" role="presentation">
                  <a href="{{route('customerTicket',$customer->id)}}" class="nav-link"> Tickets </a>
                </li>
                <li class="nav-item" role="presentation">
                  <a class="nav-link" href="{{route('customerInvoices',$customer->id)}}"> Invoices & Payments</a>
                </li>
                <li class="nav-item" role="presentation">
                  <a class="nav-link active" href="{{route('customerCommentmentFees',$customer->id)}}"> Commitment Fees</a>
                </li>
              </ul>
            </div>
            <div class="gap-col">
            ...
            <div class="tab-pane show active" id="tab-1" tabindex="0" role="tabpanel">
              <div class="card card-gutter-md">
                <div class="card-row card-row-lg col-sep col-sep-lg">
                  ...
                  <div class="card-content col-sep" style="width: 75%;">
                    <div class="card-body">
                      <div class="bio-block">
                        <h4 class="bio-block-title">Commitment fee List</h4>
                        <table class="table table-striped">
                                <tr class="thead-light">
                                    <th> Ticket ID </th>
                                    <th> Subjects </th>
                                    <th> Commetment Fees Attachment </th>
                                    <th> Commetment Fees Date </th>
                                    <th> Receiving Account </th>
                                </tr>    
                            @foreach($student as $rowStudent)
                            @php
                                $tickets = DB::table('job_tickets')->where('student_id','=',$rowStudent->id)->where('payment_attachment','!=',NULL)->first();
                            @endphp
                            @if($tickets)
                            ...
                            <tr>
                                <td> <a target="_blank" href="{{ url('/viewTicket/') }}/{{ $tickets->id }}">{{ $tickets->uid }}</a> </td>
                                    ...
                                    <td>{{$tickets->payment_attachment}} </td>
                                    <td>{{$tickets->fee_payment_date}}</td>
                                    <td>{{$tickets->receiving_account}}</td>
                                </tr> 
