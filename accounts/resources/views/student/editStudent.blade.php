                              ...
                              <div class="row">
                                 ...
                                 <div class="col-lg-2">
                                    <div class="form-group">
                                       ...
                                       <div class="form-control-wrap"><input type="text" class="form-control" id="fullName" name="customerFullName"  value="{{$customer->full_name}}" placeholder="Full name"></div>
                                    </div>
                                 </div>
                                 <div class="col-lg-2">
                                    <div class="form-group">
                                 ...
                                 <div class="col-lg-2">
                                    <div class="form-group">
                                       ...
                                       <div class="form-control-wrap"><input type="text" class="form-control" value="{{$customer->email}}" name="customerEmail" id="email" placeholder="Email address"></div>
                                    </div>
                                 </div>
                                 <div class="col-lg-2">
                                    <div class="form-group">
                                       <label for="address" class="form-label">NRIC</label>
                                       <div class="form-control-wrap"><input type="text" class="form-control" id="nric" name="cnic" value="{{$student->cnic}}" placeholder="CNIC"></div>
                                    </div>
                                 </div>
                                 <div class="col-lg-2">
                                    <div class="form-group">
                                       <label for="address" class="form-label">Phone</label>
                                       <div class="form-control-wrap"><input type="tel" minlength="9" maxlength="10" class="form-control" id="mobile_code" name="customerPhone" value="{{$customer->phone}}" placeholder="Phone"></div>
                                    </div>
                                 </div>
                                 <div class="col-lg-2">
                                    <div class="form-group">
                                       <label for="address" class="form-label">Whats App Number</label>
                                       <div class="form-control-wrap"><input type="tel" minlength="9" maxlength="10" class="form-control" id="whatsapp_code" name="whatsapp" value="{{$customer->whatsapp}}" placeholder="Whatsapp"></div>
                                    </div>
                                 </div>
                              </div>
                              <div class="row">
                                 ...
                                 <div class="col-lg-8">
                                    <div class="form-group">
                                       ...
                                       <div class="form-control-wrap"><input type="text" class="form-control" name="customerStreetAddress1" value="{{$customer->address1}}" id="streetAddress1" placeholder="Street Address "></div>
                                    </div>
                                 </div>
                                 <div class="col-lg-4">
                                    <div class="form-group">
                                       ...
                                       <div class="form-control-wrap">
                                          <input type="text"  readonly class="form-control" name="customerStreetAddress1" value="{{$customerCity->name}}" id="streetAddress1" placeholder="Street Address ">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-lg-3">
                                    <div class="form-group">
                                       ...
                                       <div class="form-control-wrap">
                                          <input type="text"  readonly class="form-control" name="customerStreetAddress1" value="{{$customerState->name}}" id="streetAddress1" placeholder="Street Address ">
                                       </div>
                                    </div>
                                 </div>
                                 <div class="col-lg-3">
                                    <div class="form-group">
                                       ...
                                       <div class="form-control-wrap"><input type="text" readonly class="form-control" name="customerPostalcode" id="postalcode" value="{{$customer->postal_code}}" placeholder="Zip code"></div>
                                    </div>
                                 </div>
                                 <div class="col-lg-3">
                                    <div class="form-group">
                                       <label for="city" class="form-label">Latitude</label>
                                       <div class="form-control-wrap"><input type="text" readonly class="form-control" name="customerLatitude" id="latitude" value="{{$customer->latitude}}" placeholder="Latitude"></div>
                                    </div>
                                 </div>
                                 <div class="col-lg-3">
                                    <div class="form-group">
                                       <label for="city" class="form-label">Longitude</label>
                                       <div class="form-control-wrap"><input type="text" readonly   class="form-control" id="customerLongitude" name="customerLongitude" value="{{$customer->longitude}}" placeholder="Longitude"></div>
                                    </div>
                                 </div>
                              </div>
                              <div class="row">
                                 ...
                                 <div class="col-lg-3">
                                    <div class="form-group">
                                       ...
                                       <div class="form-control-wrap"><input type="text" class="form-control" name="dob" value="{{$student->dob}}" placeholder="Date of Birth"></div>
                                    </div>
                                 </div>
                              </div>
                              <div class="row">
