                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <a class="dtable-cbtn bt-delete dtb-tooltip" dtb-tooltip="Delete Invoice" onclick="return confirm('Are you sure you want to delete this student Invoice?');" href="{{route('deleteStudentInvoice',$rowInvoice->id)}}"><i class="fa fa-trash"></i></a> @endcan
                        </td>
                     </tr>
                     @endif @endforeach 
                  </tbody>
