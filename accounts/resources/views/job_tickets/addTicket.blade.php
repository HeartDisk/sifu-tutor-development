                                    ...
                                    <form method="POST" action="{{route('submitJobTicket')}}"
                                        ...
                                        <h3><div class="existingStudentHeading">STUDENT INFORMATION</div></h3>
                                            ...
                                            <div class="row new_hide">
                                                ...
                                                <div class="col-lg-2">
                                                  <button class="btn btn-md btn-primary auto-caddbtn" id="addStudentBtn" type="button">Add Student</button>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="col-lg-10"></div>
                                          <div class="col-lg-2">
                                            <button class="btn btn-md btn-primary auto-caddbtn" id="addBtn"type="button">Add Subject</button>
                                          </div>
                                        </div>
