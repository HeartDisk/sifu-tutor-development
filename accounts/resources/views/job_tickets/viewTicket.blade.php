                     ...
                     <div class="bio-block sifu-view-template">
                        ...
                        <div class="row g-1 view-sindetails existingCustomer customerInfo">
                           ...
                           <div class="col-lg-3 details-item">
                              ...
                              <p><strong>@php if($tickets->customerState){ $stateName = DB::table('states')->where('id','=',$tickets->customerState)->first(); echo $stateName->name; }else{ echo "No State Selected"; } @endphp</strong></p>
                           </div>
                           <div class="col-lg-3 details-item">
                              <p class="title">City</p>
                              <p><strong>@php if($tickets->customerCity){ $cityName = DB::table('cities')->where('id','=',$tickets->customerCity)->first(); echo $cityName->name; }else{ echo "No City Selected"; } @endphp</strong></p>
                           </div>
                           <div class="col-lg-3 details-item">
                           ...
                           <div class="col-lg-12 details-item">
                              ...
                              <p><strong>{{$tickets->customerAddress1}}</strong></p>
                           </div>
                        </div>
                                                     ...
                                                     <div class="row g-3">
                                                        <div class="col-lg-6">
                                                           <div class="form-group">
                                                              ...
                                                              <div class="form-control-wrap">
                                                                 <input type="date" name="date" class="form-control" id="scheduleDate" min="">
                                                              </div>
                                                           </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="col-lg-6">
                                                           <div class="form-group">
                                                              ...
                                                              <div class="form-control-wrap">
                                                                 <input type="text" class="form-control" name="feeAmount" id="feeAmount">
                                                              </div>
                                                           </div>
                                                        </div>
                                                        <div class="col-lg-6">
                                                           <div class="form-group">
                                                              ...
                                                              <div class="form-control-wrap">
                                                                 <input type="date" class="form-control" name="feePaymentDate" id="feePaymentDate">
                                                              </div>
                                                           </div>
                                                        </div>
                                                        <div class="col-lg-6">
