                  ...
                  <div class="nk-block-head-content">
                     ...
                     <nav>
                        <ol class="breadcrumb breadcrumb-arrow mb-0">
                           ...
                           <li class="breadcrumb-item active" aria-current="page">Edit Push Notification</li>
                        </ol>
                     </nav>
                  </div>
               </div>
            ...
            <div class="nk-block">
               <div class="card card-gutter-md">
                  <div class="card-body">
                     ...
                     @endif
                     <div class="bio-block">
                        <form method="POST" action="{{url('selfpushnotification/'.$notification->id)}}" id="notifyupdateForm">
                           {{ method_field('PATCH') }}
                           @csrf
                           <div class="row g-3">
                              <div class="col-lg-4">
                              ...
                              <div class="col-lg-12">
                                 <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                       <textarea  id="" cols="90" rows="10" class="form-control" name="remark">{{$notification->remark ?? ''}}</textarea>
                                    </div>
                                 </div>
                              </div>
