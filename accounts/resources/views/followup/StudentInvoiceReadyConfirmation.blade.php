               ...
               <div class="nk-block-head-content">
                  ...
                  <nav>
                     <ol class="breadcrumb breadcrumb-arrow mb-0">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Student Invoices For Confirmation</li>
                     </ol>
                  </nav>
               </div>
            </div>
                  ...
                  <div class="card-body">
                    ...
                    <form action="{{route('StudentInvoiceReadyConfirmation')}}" method="GET">
                       ...
                       <div class="row justify-content-between tableper-row">
                          ...
                          <div class="col-md-2">
                             <div class="input-group input-group-md justify-content-end">
                                <a href="{{url('export_excel/StudentInvoiceReadyForConfirmationList')}}" class="btn-cdownload btn btn-success" title="Download"><i title="Download" class="fa fa-download"></i></a>
                             </div>
                          </div>
                       </div>
                    </form>
                    <table class="datatable-init table" data-nk-container="table-responsive">
                       ...
                       <tbody>
                          ...
                          <tr>
                             ...
                             <td>
                                <a class="dtable-cbtn bt-view dtb-tooltip" dtb-tooltip="View Tutor Detail" href="{{route('viweStudentInvoiceReadyConfirmation',$rowInvoices->id)}}"><i class="fa fa-eye"></i> </a>
