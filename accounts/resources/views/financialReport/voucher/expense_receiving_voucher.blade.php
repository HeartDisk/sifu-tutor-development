...
<section style="padding:0px;" class="forms">
    <div style="padding-right:50px !important; padding-left:50px !important" class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
            <h1 style="background:#090127; padding:10px; text-align:center; color:#fff;"> E X P E N S E  &nbsp; &nbsp;  R E C E I V E  &nbsp; &nbsp;   V O U C H E R   (Credit) </h1>
            
                    <div style="padding:0px !important" class="card-body">
                        
                        <form action="{{url('submit_expense_voucher_credit')}}" method="POST">
                            @csrf
        ...
        <tbody>
            <tr>
                <td>
                    ...
                    @php
                        $expense = DB::table('accounts')->where('type','=','Expense')->get();
                    @endphp
                    ...
                    <!--<input style="width:250px !important;"  class="arrow-togglable form-control product-id" name="customer_id[]" id="demo-1"/></td>-->
...
function test(id){
    ...
    .fail(function() {
        alert("error");
            ...
            $('#demo-1').inputpicker({
                data:[ @foreach($lims_products_list as $product)
                        {value:"{{$product->id}}",text:"{{$product->name}}",urdu:"{{$product->id}}"},
                     @endforeach
                ],
                fields:[
                     {name:'value',text:'Id'},
