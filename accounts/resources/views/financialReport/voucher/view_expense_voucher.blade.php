                            ...
                            <div class="nk-block-head-content">
                                ...
                                <nav>
                                    <ol class="breadcrumb breadcrumb-arrow mb-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">Expense Vouchers Details</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Expense Vouchers Details
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label for="firstname" class="form-label">Voucher Type: {{$customer_receive_voucher->type}}</label>
                                ...
                                <div class="col-lg-3">
                                    <div class="form-group">
                                        <label for="firstname" class="form-label">Expense Category: {{$customer_receive_voucher->expense_name}} </label>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="nk-block-head">
                                        <div class="nk-block-head-between flex-wrap">
                                            <div class="nk-block-head-content">
                                                <h3 class="nk-block-title">EXPENSE ITEMS</h3>
                                            </div>
