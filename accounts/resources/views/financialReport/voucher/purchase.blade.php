...
<section style="padding:0px;" class="forms">
    <div style="padding-right:50px !important; padding-left:50px !important" class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
            <h1 style="background:green; padding:10px; text-align:center; color:#fff;"> P A Y M E N T  &nbsp; &nbsp;  V O U C H E R   </h1>
            
                    <div style="padding:0px !important" class="card-body">
                        {!! Form::open(['url' => 'sales/321/payment_voucher', 'method' => 'post', 'id'=> 'inputform', 'onsubmit'=>'return monitor()', 'files' => true, 'class' => 'payment-form']) !!}
    ...
    <table class="order-list">
        ...
        <tbody>
            <tr>
                ...
                <td><select name="action[]"><option value="debit">Debit</option><option value="credit">Credit</option></select></td>
                <td></td>
            </tr>
        </tbody>
...
function addRow(counter){
    ...
    cols += '<td><select name="action[]"><option value="debit">Debit</option><option value="credit">Credit</option></select></td>';
    ...
    $('#demo-'+counter).inputpicker({
       ...
       $('#demo-'+counter).change(function(){
            ...
            $.ajax( {
                ...
                url:"http://sadaftraders.com/st/sales/"+id+"/supplier_balance",
            })
            .done(function(data) {
