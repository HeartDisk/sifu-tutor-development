...
<div class="rows">
    ...
    @php
        ...
        $customer = DB::table('accounts')
                        ->where('supplier_id', '=', $payments[0]->account_id)
                        ->where('account_no', '=', $payments[0]->account_id)
                        ->where('type', '=', 'supplier')
                        ->get();
                        
        $all_customer = DB::table('suppliers')->get();
    @endphp
                  
    <center><h1 style="background:green; padding:15px; color:#fff">  Supplier Transfer Edit  </h1></center>            
                ...
                <td>
        			<div class="main">
        				<div class="main-center">
        					<form class="" method="post" action="{{url('supplier-transfer-edit-post')}}">
        						@csrf
        						...
        						<div class="form-group">
        							<label for="username">Payment Note</label>
        								<div class="input-group">
