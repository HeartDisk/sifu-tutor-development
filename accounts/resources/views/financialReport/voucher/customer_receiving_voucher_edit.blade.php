...
<div class="rows">
    <div class="fluid-container">
        @if($customer_receive_voucher[0]->customer_id)
            @php
            ...
            @endphp
        @endif          
    <center><h1 style="background:green; padding:15px; color:#fff">
        @if($customer_receive_voucher[0]->customer_id)
         ( {{$customers[0]->company_name}} ) - {{$customers[0]->name}} Voucher Edit </h1></center>            
        @endif
                ...
                <td>
                        <table style="margin:0px auto; width:60%; background:#D5D5D5;">
                            ...
                            <tr>
                                ...
                                <td style="font-size:19px;">
                                    {{$customer_receive_voucher[0]->amount}}
                                </td>
                                <td style="font-size:19px;">
                                    {{$customer_receive_voucher[0]->action}}
                                </td>
                            </tr>
                        </table>                        
                </td>
                ...
                <td>
        			<div class="main">
        				<div class="main-center">
        					<form class="" method="post" action="{{url('customer-receiving-voucher-edit-post')}}">
        						@csrf
        						<input type="hidden" class="form-control" value="{{$customer_receive_voucher[0]->id}}" name="id"/>
        						...
        						<div class="form-group">
        								...
        								<div class="input-group">
        									...
        									<input type="text" class="form-control" name="amount" value="{{$customer_receive_voucher[0]->amount}}"/>
        								</div>
        						</div>
        							...
        							<label for="username">Status</label>
        								<div class="input-group">
        									...
        									<select name="action" class="form-control">
        									    <option selected value="{{$customer_receive_voucher[0]->action}}"> {{$customer_receive_voucher[0]->action}} </option>
