                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-between flex-wrap gap g-2">
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title">Add Expense Voucher</h2>
                                <nav>
                                    <ol class="breadcrumb breadcrumb-arrow mb-0">
                                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                                        <li class="breadcrumb-item"><a href="#">Expense Voucher</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Add Expense Voucher
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                        ...
                        <div class="card card-gutter-md">
                            <div class="card-body">
                                ...
                                <div class="bio-block">
                                    ...
                                    <form method="POST" action="{{url('submit-expense-voucher')}}">
                                        @csrf
                                        <div class="row g-3">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    <label for="firstname" class="form-label">Expense</label>
                                                    <div class="form-control-wrap">
                                                        <select class="form-control" name="expense_id">
                                                            <option value="">Select Expense</option>
                                                            @foreach($expenses as $expense)
                                                                <option
                                                                    value="{{$expense->id}}">{{$expense->name}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
...
{{--                                                                                          name="reference_no"--}}
{{--                                                                                          class="form-control"--}}
{{--                                                                                          value="@php echo 'EXV-'.date('dis'); @endphp"--}}
{{--                                                                                          id="reference"></div>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
