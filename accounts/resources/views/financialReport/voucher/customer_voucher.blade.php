                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-between flex-wrap gap g-2">
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title">Add Customer Voucher</h2>
                                <nav>
                                    <ol class="breadcrumb breadcrumb-arrow mb-0">
                                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                                        <li class="breadcrumb-item"><a href="#">Customer Voucher</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Add Customer Voucher
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                        ...
                        <div class="card card-gutter-md">
                            <div class="card-body">
                                ...
                                <div class="bio-block">
                                    ...
                                    <form method="POST" action="{{url('submit-customer-voucher')}}">
                                        @csrf
                                        <div class="row g-3">
