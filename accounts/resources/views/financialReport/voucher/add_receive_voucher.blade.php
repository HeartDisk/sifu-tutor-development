            ...
            <h1 style="background:orange; padding:10px; text-align:center; color:#fff;"> A D D   &nbsp; &nbsp;  R E C E I V E  &nbsp; &nbsp;  V O U C H E R   </h1>
                    ...
                    <div style="padding:0px !important" class="card-body">
                        ...
                        <div style="padding:50px; " class="row">
                            <div class="col-md-12">
                                <a class="btn btn-success" href="{{url('receive-voucher')}}">Back to Receive Voucher List</a>
    ...
    <table class="order-list">
        ...
        <tbody>
            <tr>
                ...
                <td><select name="action[]"><option value="credit">Credit</option><option value="debit">Debit</option></select></td>
                <td></td>
            </tr>
        </tbody>
