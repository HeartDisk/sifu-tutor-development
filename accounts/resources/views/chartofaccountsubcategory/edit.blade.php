               ...
               <div class="nk-block-head-between flex-wrap gap g-2">
                  <div class="nk-block-head-content">
                     <h2 class="nk-block-title">
                        Edit Chart of Accounts  Sub Category
                     </h2>
                     <nav>
                        <ol class="breadcrumb breadcrumb-arrow mb-0">
                           <li class="breadcrumb-item"><a href="#">Home</a></li>
                           <li class="breadcrumb-item"><a href="#">Chart of Accounts  Sub Category List</a></li>
                           <li class="breadcrumb-item active" aria-current="page">Edit Chart of Accounts Sub  Category</li>
                        </ol>
                     </nav>
                  </div>
               </div>
            ...
            <div class="nk-block">
               <div class="card card-gutter-md">
                  <div class="card-body">
                     ...
                     @endif
                     <div class="bio-block">
                        <form method="POST" action="{{url('submit-edit-chart-of-accounts-subcategory/'.$data->id)}}">
                           @csrf
                           <div class="row">
                                   ...
                                   <div class="form-group">
                                       ...
                                       <select name="category_id" class="form-control">
                                           @foreach($categories as $cat)
                                               <option {{$data->id==$cat->id?"selected":""}} value="{{$cat->id}}">{{$cat->name}}</option>
                                           @endforeach
                                       </select>
                                   </div>
                               </div>
