...
<head>
    ...
    <script src="https://sadaftraders.com/st/public/src/jquery.inputpicker.js"></script>
        ...
        @font-face {
              ...
              src: url('public/font/CircularStd-Black.ttf') format('truetype');
              font-weight: normal;
              font-style: normal;
            }
            
            body {
              font-family: 'CircularStdBlack', Arial, sans-serif; /* Use the custom font for the body or specific elements */
            }
    ...
    .choices__item--selectable{
        ...
        <link rel="icon" type="image/x-icon" href="{{asset('public/css/shahroz.css')}}">
</head>
<body class="nk-body" data-sidebar-collapse="lg" data-navbar-collapse="lg">
    <div id="app">
        ...
        <div class="nk-app-root">
          ...
          <div style="height:60px; background:white;" class="nk-sidebar-element nk-sidebar-head">
            <div class="nk-sidebar-brand">
              <a href="{{url('/home')}}" class="logo-link">
                <div class="logo-wrap">
                  <img src="{{asset('template/login.png')}}"/>
                </div>
              </a>
          ...
          @include('partial/sideNavigation')
        </div>
        <div class="nk-wrap">
          <div class="nk-header nk-header-fixed">
            ...
            <div class="container-fluid">
              <div class="nk-footer-wrap">
                <div class="nk-footer-copyright"> &copy; 2023 SifuTutor. Developed by <a href="https://odits.co/" target="_blank" class="text-reset">Odits</a>
                </div>
