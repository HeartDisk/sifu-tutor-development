...
class HomeController extends Controller
{
    ...
    {
        event(new TicketCreated(['message' => 'Hello, world!']));
    }
...
//            ]);
    ...
    public function index()
    {
        ...
        $incomeCollected = DB::table('class_attendeds')->whereMonth('created_at','=',Carbon\Carbon::now()->month)->where('is_paid','=','paid')->sum('totalPrice');
     ...
     public function sendTutorInvoice()
    {
        ...
        // {
            $tutor = DB::table("tutors")->where("id", 4)->first();
