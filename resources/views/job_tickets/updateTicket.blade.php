                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-between flex-wrap gap g-2">
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title">Duplicate Job Ticket</h2>
                                <nav>
                                    <ol class="breadcrumb breadcrumb-arrow mb-0">
                                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                                        <li class="breadcrumb-item"><a href="#">Job Ticket</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Duplicate Job Ticket</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="nk-block">
                        <div class="card card-gutter-md">
                            <div class="card-body">
                                ...
                                @endif
                                <div class="bio-block">
                                    <form method="POST" action="{{route('submitTDuplicateicket')}}"
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            @endphp
                                                            <select required data-search="true" data-sort="false"
                                                                    id="inCharge" name="inCharge">
                                                                <option value="">Select Admin Incharge</option>
                                                                @foreach($staffs as $rowStaff)
                                                                    <option

                                                                        {{$singleTicket->admin_charge==$rowStaff->id?"selected":""}}
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <select class="js-select" id="student_id" required
                                                                name="student_id" data-search="true" data-sort="false">
                                                            ...
                                                            @foreach($students as $rowStudents)
                                                                ...
                                                                @endphp
                                                                @if($customerCommitmentFeecheck!=null && isset($rowStudents) && isset($customersName))
                                                                    <option
                                                                        {{$singleTicket->students==$rowStudents->id?"selected":""}}
                                                                        value="{{$rowStudents->id}}">{{$rowStudents->student_id}}
                                                                        -{{$rowStudents->full_name}}
                                            ...
                                            <div class="existingCustomerDD col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        ...
                                                        <input type="text" readonly class="parentFullName form-control"
                                            ...
                                            <div style="display:none;" class="newCustomerDD col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <select id="parent_id" required name="parent_id"
                                                                data-search="true" data-sort="false" required>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <select class="classType js-select" data-search="true"
                                                            ...
                                                            <option
                                                                {{$singleTicket->mode=="online"?"selected":""}} value="online">
                                                                Online
                                                            </option>
                                                            <option
                                                                {{$singleTicket->mode=="physical"?"selected":""}}  value="physical">
                                                                Physical
                                                            </option>
                                                        </select>
                                                    </div>
                                        ...
                                        <div class="customerInfo">
                                            <h3>
                                                <div class="addNewCustomerHeading"> ADD NEW CUSTOMER / PARENT
                                                    INFORMATION
                                                </div>
                                                <div style="display:none;" class="existingCustomertHeading">CUSTOMER /
                                                    PARENT INFORMATION
                                                </div>
                                            </h3>
                                            <div class="row existingCustomer">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" readonly
                                                                   class="form-control customerFullName existing"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" readonly
                                                                   class="form-control customerGender existing"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" readonly
                                                                   class="form-control customerEmail existing"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" readonly
                                                                   class="form-control customerPhone existing"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" readonly
                                                                   class="form-control customerWhatsapp existing"/>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="input-box">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-control-wrap">
                                                                <input type="text" readonly
                                                                       class="form-control address1 existing"/>
                                                                <input type="hidden" readonly
                                                                       class="form-control customerLatitude existing"/>
                                                                <input type="hidden" readonly
                                                                       class="form-control customerLongitude existing"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="input-box">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="form-control-wrap">
                                                                <input type="text" readonly
                                                                       class="form-control landmark existing"/>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            ...
                                                            <input type="text" readonly
                                                                   class="customerState existing form-control"
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" readonly
                                                                   class="customerCity existing form-control"
                                                                   name="customerCity">
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" readonly
                                                                   class="customerPostalCode existing form-control"
                                            ...
                                            <div style="display:none;" class="row newCustomer">
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        <label for="firstname" class="form-label">Full Name</label>
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="customerFullName new form-control"
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <div class="">
                                                                <select class="js-select customerGender new"
                                                                        id="customerGender" name="customerGender"
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        <label for="email" class="form-label">Email address</label>
                                                        <div class="form-control-wrap">
                                                            <input type="text" class=" customerEmail new form-control"
                                                                   name="customerEmail" id="email"
                                                                   placeholder="Email address">
                                                            <label id="emailErrorMsg"
                                                                   style="color:red!important;display: none"
                                                                   class="form-label">Email already exist</label>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        <label for="email" class="form-label">Phone Number</label>
                                                        <div class="form-control-wrap">
                                                            <input type="text" class=" customerPhone new form-control"
                                                ...
                                                <div class="col-lg-4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text"
                                                                   class=" customerWhatsapp new form-control"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-box">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control-wrap">
                                                                <input type="text"
                                                                       class="newCustomerAddress1 new form-control"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-box">
                                                        ...
                                                        <div class="form-group">
                                                            <span class="la la-map-marker form-icon"></span>
                                                            <div class="form-control-wrap">
                                                                <input type="text" class="landmark new form-control"
                                                ...
                                                <div class=" col-lg-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text" class="customerLatitude new form-control"
                                                                   name="customerLatitude" id="customerLatitude"
                                                ...
                                                <div class=" col-lg-2">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text"
                                                                   class="customerLongitude new form-control"
                                                                   id="customerLongitude" name="customerLongitude"
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        <label for="city" class="form-label">State</label>
                                                        <div class="form-control-wrap">
                                                            <select class=" js-select customerState new"
                                                                    data-search="true" data-sort="false"
                                                                    name="customerState" id="customerState">
                                                ...
                                                <div class="col-lg-2">
                                                    <div class="form-group">
                                                        <label for="city" class="form-label">City</label>
                                                        <div class="form-control-wrap">
                                                            <select class="form-control customerCity new"
                                                                    data-search="true" data-sort="false"
                                                ...
                                                <div class="col-lg-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-control-wrap">
                                                            <input type="text"
                                                                   class=" customerPostalCode new form-control"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <input type="text" class="form-control"
                                                                   name="mainStudentFullName">
                                                        </td>
                                                        <td>
                                                            <select class="form-control" id="studentGender"
                                                                    name="mainStudentGender" data-search="true"
                                                                    data-sort="false">
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control" id="mainAge"
                                                                   name="mainAge">
                                                        </td>
                                                        <td>
                                                            <input type="text" class="form-control"
                                                                   id="mainStudentDateOfBirth"
                                                                   name="mainStudentYearOfBirth">
                                                        </td>
                                                        <td>
                                                            <select class="form-control" id="specialNeed"
                                                                    name="mainStudentSpecialNeed" data-search="true"
                                                                    data-sort="false">
                                        ...
                                        <div class="row new_hide">
                                            ...
                                            <div class="col-lg-2">
                                                <button class="btn btn-md btn-primary auto-caddbtn" id="addStudentBtn"
                                        ...
                                        <div style="display:none;" class="row g-3" id="classAddressPanel">
                                            <div class="col-lg-12">
                                                ...
                                                <input type="checkbox" id="sameAsCustomerAddress"
                                            ...
                                            <div class="col-lg-6 sameAsCustomer">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="classAddress form-control"
                                                               name="classAddress" id="classAddress">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 sameAsCustomer">
                                                <div class="form-group">
                                                    <label for="city" class="form-label">Latitude</label>
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="classLatitude form-control"
                                                               name="classLatitude" id="classLatitude"
                                                               placeholder="Latitude">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 sameAsCustomer">
                                                <div class="form-group">
                                                    <label for="city" class="form-label">Longitude</label>
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="classLongitude form-control"
                                                               id="classLongitude" name="classLongitude"
                                                               placeholder="Longitude">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 sameAsCustomer">
                                                <div class="form-group">
                                                    ...
                                                    <div class="classStateDropDown form-control-wrap">
                                                        <select class="js-select" data-search="true" data-sort="true"
                                                                name="classState" id="classState">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="text" style="display:none;"
                                                               class="classStateInput form-control" name="classState"
                                                               id="classState">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="classCityDropDown form-control-wrap">
                                                        <select class="form-control" class="" data-search="true"
                                                                data-sort="true" name="classCity" id="classCity">
                                                        </select>
                                                    </div>
                                                    <div class="form-control-wrap">
                                                        <input type="text" style="display:none;"
                                                               class="classCityInput form-control" name="classCity"
                                                               id="classCity">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4 sameAsCustomer">
                                                <div class="form-group">
                                                    <label for="postalcode" class="form-label">Postal Code</label>
                                                    <div class="form-control-wrap">
                                                        <input type="text" class="classPostalCode form-control"
                                                               name="classPostalCode" id="classPostalCode"
...
{{--                                                                            name="subject[]">--}}
                                                        ...
                                                        <td>
                                                            <select class="form-control" data-search="true"
                                                                    data-sort="true" name="subject[]" required>
                                                                <option>Select Subject</option>
                                                                @if($singleTicket->mode=="online")
                                                                @foreach($subjectsOnline as $subjectRow)
                                                                    <option
                                                                        {{$singleTicket->subjects==$subjectRow->id?"selected":""}}
                                                                        value="{{$subjectRow->id}}"> {{$subjectRow->name."(".$subjectRow->category_name.") (RM ".$subjectRow->category_price.")". "(".$subjectRow->mode.")"}}
                                                                    </option>
                                                                    @endforeach
                                                                    @else
                                            ...
                                            <div class="col-lg-10"></div>
                                            <div class="col-lg-2">
                                                <button class="btn btn-md btn-primary auto-caddbtn" id="addBtn"
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-lg-2">
                                                <button id="submitButton" class="btn btn-primary" type="submit">Submit
                                                </button>
                                            </div>
                                        </div>
                                    </form>
        ...
        $(document).ready(function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('.customerCity').text(data.customer.cityName);
            ...
            $('#addBtn').on('click', function () {
                ...
                var onlinesubjects = `<tr id="R${++rowIdx}">
                               <td class=""><select class="form-control" data-search="true" data-sort="true" name="subject[]" required><option ></option>
                                   @foreach($subjectsOnline as $subjectRow)
                <option value="{{$subjectRow->id}}"> {{$subjectRow->name."(".$subjectRow->category_name.") (RM ".$subjectRow->category_price.")". "(".$subjectRow->mode.")"}}
                </option>
@endforeach
                <select>
            </td>
    <td class=""><input class="form-control" type="number" step="any" name="classFrequency[]" required></td>
    <td class=""><input class="form-control" type="number" step="any" name="quantity[]"></td>
    <td class="">
        <label><input type="checkbox" name="day[${rowIdx}][]" value="Mon"> Mon</label>
                                       ...
                                       <td class=""><select class="form-control" name="subscription[]" required><option value="LongTerm">Long Term</option><option value="shortTerm">Short Term</option><select></td>
        ...
        <td class="">
         ...
         <td>
           <button class="btn btn-danger remove sifu-remove-btn" type="button">Remove</button>
                ...
                // $.ajax({
                //     url: "{{url('getParentStudents')}}",
                //     dataType: "json",
                //     data: {
                //         customer_id: selectedParent,
                //         _token: '{{csrf_token()}}'
                //     },
                //     type: "post",
                //     success: function (data) {
                ...
                //         {
                //           $('#selectStudent'+rowStudentIdx).empty();
                //          $('#selectStudent'+rowStudentIdx).append(data.students);
                //         }
                //     }
                // });
