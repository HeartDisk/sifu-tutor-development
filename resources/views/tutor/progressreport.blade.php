                                    ...
                                    <div class="row view-ans">
                                        <div class="col-md-12">
                                            ...
                                            <ul class="list-answeres">
                                                ...
                                                @if(isset($tutorReport->performance))
                                                    <li>
                                                        <div class="form-check checked">
                                                            <input class="form-check-input"
                                                                   value="{{$tutorReport->performance}}" type="radio"
                                                                   checked="">
                                                            <label class="form-check-label">
                                                                {{$tutorReport->performance}}
                                                            </label>
                                                        </div>
                                                    </li><br/>
                                                @endif
                                                ...
                                                @if(isset($tutorReport->performance2))
                                                    <li>
                                                        <div class="form-check checked">
                                                            <input class="form-check-input"
                                                                   value="{{$tutorReport->performance2}}" type="radio"
                                                                   checked="">
                                                            <label class="form-check-label">
                                                                {{$tutorReport->performance2}}
                                                            </label>
                                                        </div>
                                                    </li><br/>
                                                @endif
                                                ...
                                                @if(isset($tutorReport->performance3))
                                                    <li>
                                                        <div class="form-check checked">
                                                            <input class="form-check-input"
                                                                   value="{{$tutorReport->performance3}}" type="radio"
                                                                   checked="">
                                                            <label class="form-check-label">
                                                                {{$tutorReport->performance3}}
                                                            </label>
                                                        </div>
                                                    </li><br/>
                                                @endif
                                                ...
                                                <p>4. How well student answers/explains/elaborates questions given by
                                                    tutor?</p>
                                                @if(isset($tutorReport->performance4))
                                                    <li>
                                                        <div class="form-check checked">
                                                            <input class="form-check-input"
                                                                   value="{{$tutorReport->performance4}}" type="radio"
                                                                   checked="">
                                                            <label class="form-check-label">
                                                                {{$tutorReport->performance4}}
                                                            </label>
                                                        </div>
                                                    </li><br/>
                                                @endif
                                                ...
                                                <p>5. How would you rate the student's level of improvement over the
                                                    past month?</p>
                                                @if(isset($tutorReport->performance5))
                                                    <li>
                                                        <div class="form-check checked">
                                                            <input class="form-check-input"
                                                                   value="{{$tutorReport->performance5}}" type="radio"
                                                                   checked="">
                                                            <label class="form-check-label">
                                                                {{$tutorReport->performance5}}
                                                            </label>
                                                        </div>
                                                    </li><br/>
                                                @endif
                                                ...
                                                @if(isset($tutorReport->performance6))
                                                    <li>
                                                        <div class="form-check checked">
                                                            <input class="form-check-input"
                                                                   value="{{$tutorReport->performance6}}" type="radio"
                                                                   checked="">
                                                            <label class="form-check-label">
                                                                {{$tutorReport->performance6}}
                                                            </label>
                                                        </div>
                                                    </li><br/>
                                                @endif
