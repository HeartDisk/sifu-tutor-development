                     ...
                     <div class="card-body">
                        <div class="dcard-status">
                           <div class="col-md-8">
                              ...
                              @else
                              <a href="{{url($tutor->tutorImage)}}" data-lightbox="image">
                                  <img src="{{url($tutor->tutorImage)}}">
                              </a>
                              @endif
                           </div>
                           <div class="col-md-4">
                                       ...
                                       @if($appliedtickets)
                                          <div class="table-responsive">
                                             <table class="table sifu-view-cdashtable">
                                                ...
                                                <tbody>
                                                   @foreach($appliedtickets as $rowTicket)
                                                       @php
                                                         ...
                                                         <table class="table sifu-view-cdashtable">
                                                            ...
                                                            <tbody>
                                                               ...
                                                               @foreach($myApplicedTicektsTwo as $rowTicketTwo)
                                                                ...
                                                                @php
                                                              $paidCheck = DB::table('class_attendeds')->where('class_schedule_id',$rowTicketTwo->class_schedule_id)->first();
                                                              @endphp
                                                               ...
                                                               <form action="{{route('submitAttendance')}}" method="POST">
                                                                  ...
                                                                  <tr>
                                                                     ...
                                                                     <td>
                                                                        @if(isset($paidCheck) && $paidCheck->is_paid == "paid")
                                                                           <span>PAID</span>
                                                                        @else
                                                                           NOT PAID
                                                                        @endif
