                ...
                <div class="nk-block">
                   <div class="card card-gutter-md">
                      <div class="card-body">
                         ...
                         @endif
                         <div class="bio-block">
                            <form method="POST" action="{{route('submitEditProduct')}}"  enctype="multipart/form-data">
                               @csrf
                               ...
                               <div class="row g-3">
                                   <div class="col-lg-4">
                                    <div class="form-group">
                                        ...
                                        @if($product->image)
                                            <div class="mt-3">
                                                <img src="{{ asset('public/images/products/' . $product->image) }}" alt="Product Image" width="100">
                                            </div>
                                        @endif
                                    </div>
                                </div>
