...
">
    ...
    <table style="margin-top: 30px;">
        ...
        @php $totaAttendedHours = 0; $totalAmount = 0; @endphp @php
            ...
            $totalAdditionalClasses=($jobTicketDeails->totalPrice/$jobTicketDeails->classFrequency)*$jobTicketDeails->additional_classes;
        ...
        @if($jobTicketDeails->additional_classes!=0)
            <tr>

                <td style="font-size: 18px;text-align: center;padding: 20px 0px" colspan="5">
                    Addition Classes of Last Month
                </td>
            </tr>
            <tr class="details">
                <td class="tb-col"><span>{{$subjects->name}}</span></td>
                ...
                <td class="tb-col"><span>@php echo $jobTicketDeails->additional_classes; @endphp</span>
                </td>
                <td class="tb-col"><span>RM @php echo $subjects->category_price; @endphp</span></td>
                <td class="tb-col"><span>RM @php echo $totalAdditionalClasses;@endphp</span>
                </td>
            </tr>
        @endif
    </table>
        ...
        <tr class="total">
            ...
            <td>
                <div class="invoice-total-amount">
                    ...
                    <p>Total : RM {{$invoice_detail->invoiceTotal+$totalAdditionalClasses}}</p>
