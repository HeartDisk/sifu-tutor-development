...
">
        ...
        <table style="margin-top: 30px;">
            ...
            <tr class="details">
                ...
                <td class="tb-col"><span>@php echo $rowInvoiceItems->quantity; @endphp</span></td>
                <td class="tb-col"><span>@php echo $invoice_detail->classFrequency; @endphp</span>
                </td>
...
"></td>
                ...
                <td>
                    <div class="invoice-total-amount">
                        @php
                        $checkCustomerInvoice=DB::table("customer_commitment_fees")->where("customer_id",$customer->id)->first();
                        @endphp

                        @if(isset($jobTicketDeails) && $jobTicketDeails->first_invoice_sent!=true)
                        <p class="commitment" style="font-weight: 500;"><span class="titles">Customer Commitment
                                Fee:</span>&nbsp;&nbsp; &nbsp; -RM{{$checkCustomerInvoice->payment_amount}}
                        </p>
                        @endif
            ...
            <tr class="total">
                ...
                <td>
                    <div class="invoice-total-amount">
                        ...
                        @if($jobTicketDeails->first_invoice_sent==true)
                        <p>Total : RM {{$invoice_detail->invoiceTotal}}</p>
                        @elseif($checkCustomerInvoice!=null || $jobTicketDeails->first_invoice_sent!=true)
                        <p>Total : RM {{$invoice_detail->invoiceTotal-$checkCustomerInvoice->payment_amount}}</p>
                        @else
                        <p>Total : RM {{$invoice_detail->invoiceTotal}}</p>
                        @endif
        ...
        <table>
            <tr>
                <td
                    style="width: 100%;padding: 20px;background-color: #051a7a;color: #fff;font-weight: 500;letter-spacing: 2px;font-size: 14px;">
                    <table>
                        <tr>
                            <td>
                                <div class="social">
