                    ...
                    <div class="nk-block">
                        <div class="card card-gutter-md">
                            <div class="card-body">
                                ...
                                @endif
                                <div class="bio-block">
                                    <form method="POST" action="{{route('submitBlog')}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row g-3">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <select class="js-select" id="subject" data-search="true"
                                                            ...
                                                            <option selected>Pleaes select Subject</option>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap"><input required type="file"
                                                                                          class="form-control"
