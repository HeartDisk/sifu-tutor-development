                           ...
                           <div class="col-lg-6">
                              <div class="form-group">
                                 ...
                                 <div class="form-control-wrap">
                                    ...
                                    <a href="{{URL::asset('/public/MobileBlogImages/'.$singleNews->headerimage)}}" data-lightbox="image"><img src="{{URL::asset('/public/MobileBlogImages/'.$singleNews->headerimage)}}" height="45px" width="50px"></a>
                                    @endif
                                 </div>
                              </div>
                           </div>
