                                    ...
                                    @foreach($news as $rows)
                                        @if($rows->is_deleted == 0)
                                            <tr>
                                                ...
                                                <td>
                                                    @if($rows->headerimage)
                                                        <a href="{{URL::asset('/public/MobileNewsImages/'.$rows->headerimage)}}" data-lightbox="image"><img src="{{URL::asset('/public/MobileNewsImages/'.$rows->headerimage)}}" width="30px" height="30px" alt="profile Pic"></a>
                                                    @endif
                                                </td>
                                                <td>{{$rows->subject}}</td>
                                                <td>{{$rows->preheader}}</td>
                                                <td>{!! \Illuminate\Support\Str::limit($rows->content, 100, '...') !!}</td>
