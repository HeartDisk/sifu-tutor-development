                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-3">
                                 <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                       <input value="+60" type="tel" minlength="9" maxlength="13" class="form-control" name="customerPhone" id="mobile_code" placeholder="Phone" required>
                              ...
                              <div class="col-lg-3">
                                 <div class="form-group">
                                    ...
                                    Number</label>
                                    <div class="form-control-wrap"><input value="+60" type="tel" minlength="9" maxlength="13" class="form-control" name="customerWhatsapp" id="whatsapp_code" placeholder="Whatsapp" required>
                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-3">
                                 <div class="form-group">
                                    ...
                                    <div class="form-control-wrap">
                                       <select class="form-control" data-search="true" data-sort="false" name="customerState" id="customerState" required>
                              ...
                              <div class="col-lg-3">
                                 <div class="form-group">
                                    ...
                                    <div class="form-control-wrap"><input type="text" class="form-control" name="remarks" id="remarks" placeholder="remarks">
                                    </div>
                                 </div>
                              </div>
                           </div>
