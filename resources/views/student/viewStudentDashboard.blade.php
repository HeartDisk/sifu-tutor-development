                              ...
                              <div class="bio-block">
                                 ...
                                 <div class="table-responsive">
                                    <table class="table sifu-view-dashtable">
                                       ...
                                       $studentTickets = DB::table('invoices')->where("status","unpaid")->where('studentID','=',$student->id)->get();
                                       @endphp
                                       @if($studentTickets)
                                       @foreach($studentTickets as $rowTickets)
                                       <tr>
                                          <td> <a target="_blank"href="{{ url('/students/viewStudentInvoiceById/' . $rowTickets->id) }}">{{ "INV-".$rowTickets->id }}</a> </td>
                                          <td>
                                          @php
                              ...
                              <div class="bio-block">
                                 ...
                                 <div class="table-responsive">
                                    <table class="table sifu-view-dashtable">
                                       ...
                                       @php
                                       $tickets = DB::table('invoices')->where("status","paid")->where('studentID','=',$student->id)->get();
                                       @endphp
                                       @if($tickets)
