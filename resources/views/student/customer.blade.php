               ...
               <div class="card-body">
                     ...
                     <div class="row justify-content-between tableper-row">
                        ...
                        <div class="col-md-4">
                           <div class="input-group input-group-md">
                              ...
                              <select name="status" class="form-select" id="inputGroupSelect01">
                                 ...
                                 <option value="Unregistered" {{ Request::get('status') == 'Unregistered' ? 'selected' : '' }}>Unregistered</option>
                        ...
                        <div class="col-md-5">
                           <div class="input-group input-group-md">
                              ...
                              <input name="search" type="text" class="form-control" placeholder="Customer Name, Phone or Email" value="{{ Request::get('search')}}" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm">
                           </div>
                        </div>
                        <div class="col-md-3">
                           <div class="input-group input-group-md">
                  ...
                  <table class="datatable-init table" data-nk-container="table-responsive">
                     ...
                     <tbody>
                        ...
                        ->get();
                        @endphp
                        @if($row->is_deleted == 0 && $row->full_name!=null && $row->email!=null)
                        <tr>
                           <td>{{$number++}}</td>
                           <td>{{$row->uid}}</td>
                           ...
                           @if($commitmentFee!=null && $commitmentFee->payment_attachment!=null)
                           <td>
