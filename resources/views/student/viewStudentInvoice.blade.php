                                 ...
                                 <div class="nk-block-head-content">
                                    ...
                                    <nav>
                                       <ol class="breadcrumb breadcrumb-arrow mb-0">
                                          ...
                                          <li class="breadcrumb-item active" aria-current="page">Invoice Preview</li>
                                       </ol>
                                    </nav>
                                 </div>
                                 <div class="nk-block-head-content">
                                             ...
                                             <tbody>
                                                 ...
                                                 @foreach($invoice_items as $rowInvoiceItems)
                                                    <tr>
                                                       ...
                                                       <td class="tb-col"><span>
                                                           @php 
                                                                echo round($rowInvoiceItems->totalTime);
                                                                $totaAttendedHours+=round($rowInvoiceItems->totalTime);
                                                            @endphp 
                                                           
                                                           </span></td>
                                                       <td class="tb-col"><span>@php echo round($subjects->price); @endphp </span></td>
                                                       <td class="tb-col"><span>
                                                            @php 
                                                                echo round($rowInvoiceItems->totalTime) * $subjects->price; 
                                                                $totalAmount+=round($rowInvoiceItems->totalTime) * $subjects->price;
                                                            @endphp </span></td>
                                                    </tr>
