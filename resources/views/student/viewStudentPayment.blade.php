                           ...
                           <div class="nk-block-head">
                              <div class="nk-block-head-between flex-wrap gap g-2">
                                 <div class="nk-block-head-content">
                                    ...
                                    View Invoice Payment</h1>
                                    <nav>
                                       <ol class="breadcrumb breadcrumb-arrow mb-0">
                                          <li class="breadcrumb-item"><a href="#">Home</a></li>
                                          <li class="breadcrumb-item"><a href="#">Invoice</a></li>
                                          <li class="breadcrumb-item active" aria-current="page">view Invoice Payment</li>
                                       </ol>
                                    </nav>
                                 </div>
                                 <div class="nk-block-head-content">
                                          ...
                                          <table class="table nk-invoice-table">
                                             ...
                                             <tbody>
                                                 ...
                                                 @endphp
                                                    ...
                                                    <tr>
                                                       ...
                                                       <td class="tb-col"><span>
                                                         {{$rowInvoiceItems->quantity}}
                                                           </span></td>
                                                       <td class="tb-col"><span>{{$subjects->category_price}} </span></td>
                                                       <!--$invoice_detail->invoiceTotal-->
                                                       <td class="tb-col"><span>{{$invoice_detail->invoiceTotal}} </span></td>
                                                       <!--<td class="tb-col"><span>{{$rowInvoiceItems->quantity*$subjects->category_price}} </span></td>-->
                                                    </tr>
                                             ...
                                             <tfoot class="table-dark">
                                                <tr>
                                                   ...
                                                   <td></td>
                                                   <td>{{$invoice_detail->invoiceTotal}}</td>
                                                </tr>
                                             </tfoot>
                                          </table>
                                       </div>
