                                ...
                                <div class="nk-block-head-content">
                                    <div class="d-flex flex-column flex-md-row align-items-md-center">
                                        <div class="mt-3 mt-md-0 ms-md-3">
                                            <br/><br/>
                                            <h3 class="title mb-1">Edit Sale Invoice
                                                : {{$invoice_detail->reference}}</h3>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="nk-block">
                        <div class="card card-gutter-md">
                            <div class="card-body">
                                ...
                                @endif
                                <div class="bio-block">
                                    <form method="POST" action="{{ route('submitEditInvoice') }}">
                                        @csrf  <!-- CSRF protection ke liye -->
                                        <input type="hidden" name="saleInvoiceID" value="{{ $invoice_detail->id }}">
                                        <div class="row g-3">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        <input type="date" name="invoiceDate"
                                                               value="{{ \Carbon\Carbon::parse($invoice_detail->invoiceDate)->format('Y-m-d') }}"
                                                               class="form-control" id="invoice_date">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap"><input readonly type="text"
                                                                                          name="reference"
                                                                                          class="form-control"
                                                                                          value="{{$invoice_detail->reference}}"
                                                                                          id="reference"></div>
                                                </div>
                                            </div>
                                            ...
                                            <!--                <option-->
                                            <!--                    selected="selected">{{$invoice_detail->managementStatus}}</option>-->
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap"><input type="text" name="payerName"
                                                                                          class="form-control"
                                                                                          id="payerName"
                                                                                          value="{{$invoice_detail->payerName}}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap"><input type="text" name="payerEmail"
                                                                                          class="form-control"
                                                                                          id="payerEmail"
                                                                                          value="{{$invoice_detail->payerEmail}}">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap"><input type="text"
                                                                                          ...
                                                                                          class="form-control"
                                                                                          id="payerPhoneNumber"
                                                                                          value="{{$invoice_detail->payerPhone}}">
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody id="tbodyDeduction">
                                                            ...
                                                            <tr id="">
                                                                <td><textarea class="form-control sifu-descr"  name="deductionDescription[]">{{$deduction->description}}</textarea></td>
                                                                <td><input type="text" class="form-control" value="{{$deduction->amount}}" name="deductionAmount[]"/></td>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap"><textarea name="remarks"
                                                                                             class="form-control"
                                                                                             style="min-height:30px;max-height:45px">{{$invoice_detail->remarks}}</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row g-3">
                                                ...
                                                <script>
                                                    $(document).ready(function () {
                                                        ...
                                                        var rowIdx = "{{count($invoice_items)}}";
                                                ...
                                                <td class="row-index text-center"><select class="form-control js-select" data-search="true" data-sort="false" name="subject[]" id="subject${rowIdx}">@foreach($subjects as $subjectRow)<option value="{{$subjectRow->id}}"> {{$subjectRow->name."(".$subjectRow->category.")"}}</option>@endforeach<select></td>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered">
                                                            ...
                                                            <tr style="background-color:#2e314a; color:#fff">
                                                                ...
                                                                <th style="width:180px !important;" class="text-center">
                                                                    Students
                                                                </th>
                                                                <th style="width:150px !important;" class="text-center">
                                                                    Subjects
                                                                </th>
                                                            ...
                                                            <tbody id="tbody">
                                                            @foreach($invoice_items as $rowIdx => $item)
                                                                <tr>
                                                                    <td class="row-index text-center">
                                                                        <textarea class="form-control"
                                                                                  id="description{{ $rowIdx }}"
                                                                                  name="description[]"
                                                                                  style="max-height:45px">{{ $item->description }}</textarea>
                                                                    </td>
                                                                    <td class="row-index text-center">
                                                                        <select class="form-control" name="students[]"
                                                                            ...
                                                                            @foreach($students as $studentsRow)
                                                                                <option
                                                                                    value="{{ $studentsRow->id }}" {{ $item->studentID == $studentsRow->id ? 'selected' : '' }}>
                                                                    ...
                                                                    <td class="row-index text-center">
                                                                        <select class="form-control" name="subject[]"
                                                                            ...
                                                                            @foreach($subjects as $subjectRow)
                                                                                <option
                                                                                    value="{{ $subjectRow->id }}" {{ $item->subjectID == $subjectRow->id ? 'selected' : '' }}>
                                                                                    {{ $subjectRow->name ."(".$subjectRow->category.")" }}
                                                                                </option>
                                                                            @endforeach
                                                                        </select>
                                                                    </td>
                                                                    ...
                                                                    <td class="text-center">
                                                                        <button
                                                                            style="background-color:#2e314a; color:#fff"
                                            ...
                                            <div class="row g-3">
                                                <div class="col-lg-12">
                                                    ...
                                                    <a href="{{url("/students/StudentInvoices")}}">
                                                        <button style="background-color:#2e314a; color:#fff"
                                                                class="btn btn-primary" type="button">Back
                                                        </button>
                                                    </a>
