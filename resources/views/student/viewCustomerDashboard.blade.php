                      ...
                      <div class="card-body">
                            <div class="dcard-status">
                               <div class="col-md-8">
                                   ...
                                   @else
                                    <a href="{{url($customer->image)}}" data-lightbox="image">
                               ...
                               <div class="bio-block">
                                  ...
                                  <div class="table-responsive">
                                     <table class="table sifu-view-dashtable">
                                        ...
                                        ->leftJoin('class_schedules', 'invoices.ticketID', '=', 'class_schedules.ticketID')
                                        ->select(
                                            'invoices.*',
                                            DB::raw("
                                                CASE 
                                        ...
                                        ->where('invoices.studentID', '=', $rowStudent->id)
                                        ->groupBy('invoices.id') // Ensure you're grouping by the primary key
                                        ->get();
                                        ...
                                        @foreach($tickets as $ticket)
                                            @if($ticket->show_invoice == 'true')
                                             <tr>
                                               <td> <a target="_blank" href="{{route('viewStudentInvoiceById',$ticket->id)}}">{{"INV-".$ticket->id}}</a> </td>
                               ...
                               <div class="bio-block">
                                  ...
                                  <div class="table-responsive">
                                     <table class="table sifu-view-dashtable">
                                        ...
                                        @foreach($student as $rowStudent)
                                        @php
                                        $tickets = DB::table('invoices')->where('status','=','paid')->where('studentID','=',$rowStudent->id)->first();
                                        @endphp
                                        @if($tickets)
                                        <tr>
