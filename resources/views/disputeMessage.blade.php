                    ...
                    <div class="row flex-lg-row-reverse">
                        ...
                        <div class="col-lg-7 align-self-center">
                            <div class="card-body is-theme ps-lg-4 pt-5 pt-lg-0">
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="h1 title mb-3">We hope this message finds you well. We would like to extend our sincere apologies for any
                                            inconvenience caused recently.We understand the
                                            importance of your time and the impact that any inconvenience may have had. Please know that we are taking immediate steps to
                                            address the issue and prevent it from happening again in the future.</div>
