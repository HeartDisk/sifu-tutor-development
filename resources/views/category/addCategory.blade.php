                           ...
                           <div class="row g-3">
                              ...
                              <div class="col-lg-4">
                                 <div class="form-group">
                                    ...
                                    <div class="form-control-wrap"><input type="text" class="form-control" name="tutor_longterm_commission_before_eight_hours" required></div>
                                 </div>
                              </div>
                              ...
                              <div class="col-lg-4">
                                 <div class="form-group">
                                    ...
                                    <div class="form-control-wrap"><input type="text" class="form-control" name="tutor_longterm_commission_after_eight_hours" required></div>
                                 </div>
                              </div>
                              ...
                              <div class="col-lg-4">
                                 <div class="form-group">
                                    ...
                                    <div class="form-control-wrap"><input type="text" class="form-control" name="tutor_shorterm_commission" required></div>
                                 </div>
                              </div>
