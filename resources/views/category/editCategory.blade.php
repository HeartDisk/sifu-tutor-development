                     ...
                     <div class="bio-block">
                        <form method="POST" action="{{route('submitEditCategory')}}">
                           ...
                           <div class="row">
                              ...
                              <div class="col-lg-4">
                                 <div class="form-group">
                                    <label for="firstname" class="form-label">Long-term Commission before 8 hours</label>
                                    <div class="form-control-wrap"><input type="text" class="form-control" value="{{$category->tutor_longterm_commission_before_eight_hours}}"  name="tutor_longterm_commission_before_eight_hours" required></div>
                                 </div>
                              </div>
                              
                              <div class="col-lg-4">
                                 <div class="form-group">
                                    <label for="firstname" class="form-label">Long-term Commission after 8 hours</label>
                                    <div class="form-control-wrap"><input type="text" class="form-control" value="{{$category->tutor_longterm_commission_after_eight_hours}}"  name="tutor_longterm_commission_after_eight_hours" required></div>
                                 </div>
                              </div>
                              ...
                              <div class="col-lg-4">
                                 <div class="form-group">
                                    <label for="firstname" class="form-label">Short-term Commission</label>
                                    <div class="form-control-wrap"><input type="text" class="form-control" value="{{$category->tutor_shorterm_commission}}"  name="tutor_shorterm_commission" required></div>
                                 </div>
                              </div>
