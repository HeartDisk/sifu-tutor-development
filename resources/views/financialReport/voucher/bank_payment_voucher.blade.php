...
<section style="padding:0px;" class="forms">
    <div style="padding-right:50px !important; padding-left:50px !important" class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
            <h1 style="background:#090127; padding:10px; text-align:center; color:#fff;"> B A N K  &nbsp; &nbsp;  P A Y M  E N T &nbsp; &nbsp; V O U C H E R  (Debit) </h1>
            
                    <div style="padding:0px !important" class="card-body">
                        
                        <form action="{{url('submit_bank_voucher_debit')}}" method="POST">
                            @csrf
