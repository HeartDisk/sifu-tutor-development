...
<section style="padding:0px;" class="forms">
    <div style="padding-right:50px !important; padding-left:50px !important" class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
            <h1 style="background:#E503D4; padding:10px; text-align:center; color:#fff;"> B A N K  &nbsp; &nbsp; R E C E I V E &nbsp; &nbsp;  V O U C H E R  (Credit) </h1>
            
                    <div style="padding:0px !important" class="card-body">
                        
                        <form action="{{url('sales/321/bank_voucher')}}" method="POST">
