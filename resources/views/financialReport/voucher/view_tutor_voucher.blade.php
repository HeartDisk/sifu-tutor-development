                ...
                <div class="nk-content-body">
                            ...
                            <div class="nk-block-head-content">
                                ...
                                <nav>
                                    <ol class="breadcrumb breadcrumb-arrow mb-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="#">Tutor Vouchers Details</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Tutor Vouchers Details
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                    ...
                    <div class="nk-block">
                        <div class="card">
                            ...
                            <div class="col-lg-3">
                                <div class="form-group">
                                    <label for="firstname" class="form-label">Customer: {{$customer_receive_voucher->tutor_name}} </label>
                                </div>
                            </div>
