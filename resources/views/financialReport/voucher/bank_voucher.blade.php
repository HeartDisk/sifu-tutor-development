                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-between flex-wrap gap g-2">
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title">Add Bank Voucher</h2>
                                <nav>
                                    <ol class="breadcrumb breadcrumb-arrow mb-0">
                                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                                        <li class="breadcrumb-item"><a href="#">Bank Voucher</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Add Bank Voucher
                                        </li>
                                    </ol>
                                </nav>
                            </div>
                        ...
                        <div class="card card-gutter-md">
                            <div class="card-body">
                                ...
                                <div class="bio-block">
                                    ...
                                    <form method="POST" action="{{url('submit_bank_voucher')}}">
                                        @csrf
                                        <div class="row g-3">
                                            ...
                                            <div class="col-lg-3">
                                                <div class="form-group">
                                                    <label for="firstname" class="form-label">Bank</label>
                                                    <div class="form-control-wrap">
