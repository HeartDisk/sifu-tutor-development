...
<section style="padding:0px;" class="forms">
    <div style="padding-right:50px !important; padding-left:50px !important" class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="card">
            <h1 style="background:#090127; padding:10px; text-align:center; color:#fff;"> T U T O R    &nbsp; &nbsp;  R E C E I V E  &nbsp; &nbsp;  V O U C H E R   &nbsp; &nbsp;  (CREDIT) </h1>
            
                    <div style="padding:0px !important" class="card-body">
                        
                        <form action="submit_tutor_receive_voucher" method="POST" id="inputform" onsubmit="return monitor()" class="payment-form">
                                                ...
                                                <table class="order-list">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @php
                                                                    $customers = DB::table('tutors')->get();
                                                                @endphp
                                                                
                                                                <select class="form-control" name="customer_id[]">
                                                                    @foreach($customers as $rowCustomer)
                                                                        <option value="{{$rowCustomer->id}}">{{$rowCustomer->uid}} - {{$rowCustomer->full_name}}</option>
                                                                    @endforeach     
                                                                </select>
                                                                </td>
...
function addRow(counter){
    ...
    $('#demo-'+counter).inputpicker({
       data:[ @foreach($lims_products_list as $product)
                        {value:"{{$product->id}}",text:"{{$product->full_name}}",urdu:"{{$product->city}}"},
                     @endforeach
                ],
                fields:[
                     {name:'value',text:'ID'},
       ...
       $('#demo-'+counter).change(function(){
            ...
            $.ajax( {
                ...
                url:"https://sadaftraders.com/st/sales/"+id+"/customer/balance",
...
$(document).ready(function(){
        $("#demo-1").change(function(){
            ...
            $.ajax( {
                ...
                url:"https://sadaftraders.com/st/sales/"+id+"/supplier_city",
            })
            .done(function(data) {
                var product = jQuery.parseJSON(data);
