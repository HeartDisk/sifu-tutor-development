...
<div class="rows">
    ...
    <div class="table-responsive">
        <center><h1 style="background:#090127; padding:15px; color:#fff"> Tutors Voucher List </h1></center>
        <table id="customer-table" class="table table-striped">
              <thead class="table-dark">
                ...
                <tr>
                  ...
                  <th style="font-size:19px;"scope="col">Tutors Detail</th>
              ...
              <tbody>
                  @foreach($supplier_receive_voucher as $row)
                        <tr>
                          ...
                          <th style="font-size:19px;" scope="row">{{$row->name}} <span style="font-size:14px !important;"> {{$row->city}} </span> </th>
