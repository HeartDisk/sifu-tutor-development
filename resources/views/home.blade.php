               ...
               <div class="col-sm-6 col-xl-6 col-xxl-3">
                  <div
                     ...
                     <div style="padding:0px !important" class="card-body">
                        ...
                        <div class="mt-2 mb-4">
                           <div style="color:#fff"
                              class="amount h1">@php $allTutors = DB::table('tutors')->where("status","verified")->count('id'); @endphp {{$allTutors}} </div>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="col-sm-6 col-xl-6 col-xxl-3">
                  <div
                     ...
                     <div style="padding:0px !important" class="card-body">
                        ...
                        <div class="mt-2 mb-4">
                           <div style="color:#fff"
                              class="amount h1">@php $allStudents = DB::table('students')->where("status","active")->count('id'); @endphp {{$allStudents}} </div>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="col-sm-6 col-xl-6 col-xxl-3">
                  <div
                     ...
                     <div style="padding:0px !important" class="card-body">
                        ...
                        <div class="mt-2 mb-4">
                           <div style="color:#fff"
                              class="amount h1">@php $allStudentsThisMonth = DB::table('students')->where("status", "active")->whereMonth('created_at', date('m'))->whereYear('created_at', date('Y'))->count('id'); @endphp {{$allStudentsThisMonth}} </div>
                        </div>
                     </div>
                  </div>
               </div>
