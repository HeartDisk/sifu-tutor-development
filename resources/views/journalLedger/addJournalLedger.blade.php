...
@section('content')
                    ...
                    <div class="nk-block-head">
                        <div class="nk-block-head-between flex-wrap gap g-2">
                            <div class="nk-block-head-content">
                                <h2 class="nk-block-title">Add Journal Ledger</h2>
                                <nav>
                                    <ol class="breadcrumb breadcrumb-arrow mb-0">
                                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                                        <li class="breadcrumb-item"><a href="#">Journal Ledger</a></li>
                                        <li class="breadcrumb-item active" aria-current="page">Add Journal Ledger</li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
                    ...
                    <div class="nk-block">
                        <div class="card card-gutter-md">
                            <div class="card-body">
                                ...
                                @endif
                                <div class="bio-block">
                                    <form method="POST" action="{{route('submitJournalLedger')}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row g-3">
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap"><input type="date"
                                                                                          ...
                                                                                          class="form-control"
                                                                                          value="@php echo 'INV-'.date('dis'); @endphp"
                                                                                          id="reference"></div>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
    ...
    <script>
        $(document).ready(function () {
         ...
         <td class="row-index text-center"><select class="form-control js-select" data-search="true" data-sort="false" name="chartOfAccounts[]" id="account_id${rowIdx}">@foreach($chartOfAccounts as $account)<option value="{{$account->id}}"> {{$account->name. "(".$account->code.")"}}</option>@endforeach<select></td>
