...
return [
   ...
   'apps' => [
        [
            'id' => env('PUSHER_APP_ID', 'my-websocket-app-id'),
            'name' => env('PUSHER_APP_NAME', 'My WebSocket App'),
            'key' => env('PUSHER_APP_KEY', 'abcd1234key'),
            'secret' => env('PUSHER_APP_SECRET', 'my-secret-key'),
